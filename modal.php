    ...
    <form action="" method="POST">
      ...
      <div class="modal-body mx-3">
        <div class="md-form mb-5">
          ...
          <input type="text" id="orangeForm-name" class="form-control validate" required name="name">
          <label data-error="wrong" data-success="right" for="orangeForm-name">Your name</label>
        </div>

        <div class="md-form mb-5">
          <i class="fas fa-mobile prefix grey-text"></i>
          <input type="tel" id="orangeForm-name" class="form-control validate" name="phone" required>
        ...
        <div class="md-form mb-5">
          ...
          <input type="text" id="orangeForm-name" class="form-control " name="admission" required>
      ...
      <div class="modal-footer d-flex justify-content-center">
        <button class="btn btn-deep-orange" name="signup">Sign up</button>
      </div>
      </form>
    </div>
  </div>
